  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-blue-100 text-gray-900 scroll-smooth">
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-black/40 z-0" /> {/* Dark overlay for better text readability */}
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold leading-tight text-white">
            Welcome to{' '}
            <span className="text-blue-200">MediConnect</span>
          </h1>
          ...
          <div className="mt-8">
            <button className="bg-white text-blue-700 hover:bg-blue-50 px-8 py-4 rounded-xl font-semibold shadow-lg transition text-lg">
              Get Started
            </button>
          </div>
        </motion.div>
        ...
        return (
          ...
          >
            ...
            <div className="md:w-1/2">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 px-5 py-2 rounded-xl font-medium text-white">
                {section.button}
              </button>
            </div>
          </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="text-gray-600 mb-6 text-lg">
              ...
              through our hospital referral system.
            </p>
            <button className="bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-full font-semibold text-white transition duration-200">
              Contact Support
            </button>
          </div>
